...
As shown below in the sandbox application `mixin: 'input-date'` has been added to fields.js. 
...
![Field with prefix and suffix](../../static/images/wiki_how_tos/validation-summary-clickable.png)
