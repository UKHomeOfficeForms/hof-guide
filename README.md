...
5.  Update in the `config.js` file the `pathPrefix` key to match the repo-name you have pushed to. In this case, this repo is called `hof-guide` so you can see this as:
    ```js
