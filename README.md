...
1.  **Installing the Wiki**
    ...
    Start this site by ensuring at least [Node 20.18.2](https://nodejs.org/en/blog/release/v20.18.2/) is installed. You can do this using [Node Version Manager (NVM)](https://tecadmin.net/install-nvm-macos-with-homebrew/) and following the following instructions:
    ```shell
    # Use Node Version Manager to install Node v20.18.2 (latest LTS version)
    nvm install 20.18.2
    # Then use Node v20.18.2 before installing project dependencies
    nvm use 20.18.2
