      ...
      <div className="govuk-header__logo">
        <a href="https://www.gov.uk/" className="govuk-header__link govuk-header__link--homepage">
          <span className="govuk-header__logotype">
            <svg className="govuk-header__logotype-crown" aria-hidden="true" focusable="false" height="30" width="36" viewBox="0 0 132 97" xmlns="http://www.w3.org/2000/svg">
...
Header.defaultProps = {
  siteTitle: `Home Office Forms (HOF) Guide`,
};
